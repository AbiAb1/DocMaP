...
$sql = "SELECT t.TaskID AS TaskID, t.Title AS TaskTitle, t.taskContent,t.Status, t.DueDate, t.DueTime, d.dept_name, fc.Title AS ContentTitle, fc.Captions
        FROM tasks t
        LEFT JOIN feedcontent fc ON t.ContentID = fc.ContentID
        LEFT JOIN department d ON fc.dept_ID = d.dept_ID
        WHERE t.Type = 'Announcement'
                    ...
                    <tbody id="announcementTable">
                        <?php foreach ($announcements as $announcement): ?>
                            <tr>
                                ...
                                <td><p><?php echo $announcement['taskContent']; // Direct output to render HTML content ?></p></td>
